                                ...
                                <div className="left-divider">
                                    <div className="col-md-6">
                                        <form className="form" onSubmit={e => onSubmit(e)}>
                                            ...
                                            <center><h1>BYK Customer Register Page</h1></center>
                                                <label htmlFor="name">Name :</label>
                                                <input type="text" placeholder="Name" name="name" value={name} className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="email">Email-ID:</label>
                                                <input required name="email" placeholder="Email" value={email} type="email" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="mob-number">Mobile-No.:</label>
                                                <input required id="mob-number" placeholder="Mob-No" type="text" name="contact" value={contact} className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
