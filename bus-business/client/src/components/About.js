...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.3/css/all.css" integrity="sha384-UHRtZLI+pbxtHCWp1t77Bi1L4ZtiqrqD80Kn4Z8NTSRyMA2Fd33n5dQ8lWUE00s/" crossorigin="anonymous" />
                ...
                <div className="container h-100">
                    <div className="row h-100 align-items-center">
                        <div className="col-md-12 text-center">
                            <h1><strong>Welcome to BYK Bus Booking Social Plateform</strong></h1>
                            <p>
    ...
    <section className="message py-5">
      <div className="container text-center">
        ...
        <p>
        BYK Bus is part of India’s leading online travel company MakeMyTrip Limited (NASDAQ: MMYT). By providing widest choice, superior customer service, lowest prices and 
                            unmatched benefits.
        </p>
      ...
      <h1>Follow us for more details</h1>
          <div className="container">
            ...
            <div className="col-md-12">
              ...
              <p><i className="bi bi-youtube"></i></p>
